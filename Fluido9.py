...
def main():
    ...
    # Initial condition
    velocity_x_prev = np.ones((N_POINTS_Y + 1, n_points_x)) * 1.0  # Adjusting initial velocity
    ...
    obstacle_start_x = n_points_x // 5
    obstacle_end_x = 2 * n_points_x // 5
    obstacle_start_y = N_POINTS_Y // 3
    obstacle_end_y = 2 * N_POINTS_Y // 3
    ...
    for iter in tqdm(range(N_TIME_STEPS)):
        ...
        velocity_x_tent[obstacle_start_y:obstacle_end_y, obstacle_start_x:obstacle_end_x] = 0.0
        ...
        velocity_y_tent[obstacle_start_y:obstacle_end_y, obstacle_start_x:obstacle_end_x] = 0.0
        ...
        velocity_x_next[obstacle_start_y:obstacle_end_y, obstacle_start_x:obstacle_end_x] = 0.0
        velocity_y_next[obstacle_start_y:obstacle_end_y, obstacle_start_x:obstacle_end_x] = 0.0
